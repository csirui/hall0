...
from tyframework._private_.dbredis.txredis import exceptions
from tyframework._private_.dbredis.txredis.protocol import RedisBase, HiRedisBase
...
class RedisClientFactory(ReconnectingClientFactory):
    ...
    def execute_command(self, *argl, **argd):
        return self.client.send(*argl)
