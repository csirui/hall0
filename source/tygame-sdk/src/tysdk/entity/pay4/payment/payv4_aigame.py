...
class TuYouPayAiGameV4(PayBaseV4):
    resultcode_msg = {
        '00': '订购成功',
        '01': '短代格式错误',
        '02': '合作方代码错误',
...
'''
    ...
    @payv4_callback('/open/ve/pay/aigame/callback')
    def doAiGameMsgCallback(self, rpath):
        ...
        if resultcode == '00':
            ...
            PayHelperV4.callback_error(orderPlatformId, 'resultCode(%s) not 0' % resultcode, notifys)
