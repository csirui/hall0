...
class TuyouPayGoogleIAB(object):
    @classmethod
    ...
    def doGoogleIABCallback(cls, rpath):
        ...
        if not action or action == '':
            ...
            if action == 'redelivery':
                ...
                if False and cls.doGoogleIABCallbackVerify(base64PublicKey, signData, signature) != True:
                    result['state'] = 'error'
            ...
            if cls._is_google_transaction_delivered(platformOrderId):
                ...
                TyContext.ftlog.error('doGoogleIABCallback->order is already-delivered:', platformOrderId)
                return cls._dict2string(result)
