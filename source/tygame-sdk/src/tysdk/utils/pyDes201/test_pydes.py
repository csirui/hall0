...
t = time()
d = 'order0201402111536470028918108304545131000B2000000B000A8001CZ14021121481207'
padByte = chr(5)
ivBytes = ''
ivSource = "12345678"
for i in ivSource:
...
t1 = triple_des(unhex("B97FED4E9994E33353F2A65A063DFAA8A31428E11BD7AE59"), mode=CBC, pad=padByte, IV=ivBytes,
                padmode=PAD_NORMAL)
